...
overlap = .5;
opt = 'ap';
% gt_bbox is an array of struct containing BB, diff, det. one strcut per
% one image
% pred_bbox is a cell of predicted bbox. one cell per one image
