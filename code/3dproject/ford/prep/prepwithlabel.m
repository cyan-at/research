...
addpath '/mnt/neocortex/scratch/jumpbot/research/code/3dproject/library/utilities/matlab/mat2pcd/';
...
start = true;
if start
%catalogue the folders in train, and test, and iterate through them
p = strcat(imageRoot,'train/');
catalogue(strcat(imageRoot,'train/'),'folder');
