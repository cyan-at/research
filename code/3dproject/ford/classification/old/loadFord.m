rootSrcPath = 	'/mnt/neocortex/scratch/jumpbot/data/3dproject/fordsource';
rootSavePath =  '/mnt/neocortex/scratch/jumpbot/data/3dproject/2_18_13';
ensure(rootSavePath);
rootFeaturePath = sprintf('%s/features',rootSavePath);
ensure(rootFeaturePath);

matRootPath = rootSrcPath;
